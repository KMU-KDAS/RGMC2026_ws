...
RETREAT_DISTANCE = 0.008
T_RETREAT_DISTANCE = 0.005
T_BASE_SCALE = 1.06
SQUARE_SCALE = 1.06
CIRCLE_SCALE = 1.06
# =========================================================
...
SHAPE_DB = {
    "square": { # 한쪽으로 무게가 쏠린 정사각형 블록
        ...
        "cases": { # 가능한 무게중심 가설(Case)들
            ...
            "CASE_0": {"m": 0.008, "I": 0.00000133, "com": np.array([0.0, 0.0])},
            # CASE_1_A: 무게추(너트)가 왼쪽(-x 방향)으로 약간 쏠린 상태
            "CASE_1_A": {"m": 0.0085, "I": 0.00000137, "com": np.array([-0.000375, 0.0])},
            # CASE_1_B: 무게추가 왼쪽 위(대각선)로 쏠린 상태
            "CASE_1_B": {"m": 0.0085, "I": 0.00000137, "com": np.array([-0.000291, 0.000291])},
            # CASE_1_C: 무게추가 왼쪽 아래로 쏠린 상태
            "CASE_1_C": {"m": 0.0085, "I": 0.00000137, "com": np.array([-0.000291, -0.000291])},
            # CASE_2, 3 시리즈: 무게추가 2개, 3개씩 달려서 무게중심이 더 극단적으로 변한 상태들
            "CASE_2_AB": {"m": 0.09, "I": 0.00000141, "com": np.array([-0.000640, 0.000280])},
            "CASE_2_AC": {"m": 0.09, "I": 0.00000141, "com": np.array([-0.000640, -0.000280])},
            "CASE_2_BC": {"m": 0.09, "I": 0.00000141, "com": np.array([-0.000560, 0.0])},
            "CASE_3_ALL": {"m": 0.095, "I": 0.00000145, "com": np.array([-0.000885, 0.0])},
        },
    },
